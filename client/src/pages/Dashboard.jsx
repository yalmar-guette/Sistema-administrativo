...
import {
    Package, DollarSign, TrendingUp, ShoppingCart, Building2, AlertCircle, LogOut,
} from 'lucide-react';
...
export default function Dashboard() {
    const {
        user, currentOrganization, currentInventory, getCurrentRole, logout,
    } = useAuth();
    ...
    // Redirect for superuser if no inventory selected
    useEffect(() => {
    ...
    if (!loading && !currentInventory) {
        ...
        // Superuser: can go to organizations (fallback if redirect is slow)
                    ...
                    <div className="flex items-center justify-center min-h-[60vh]">
                        <div className="text-center max-w-md">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-6">
                                Como superusuario, puedes gestionar todas las organizaciones.
                            </p>
