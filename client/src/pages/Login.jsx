  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-red-500 via-primary-600 to-red-700 dark:from-gray-900 dark:via-gray-800 dark:to-black transition-colors duration-500">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
