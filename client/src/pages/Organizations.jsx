...
import {
  Plus, Edit2, Trash2, Users, Package, Building2,
} from 'lucide-react';
...
export default function Organizations() {
  // Using getCurrentRole from context
  const {
    user, currentOrganization, switchOrganization, loadInventories, getCurrentRole,
  } = useAuth();
